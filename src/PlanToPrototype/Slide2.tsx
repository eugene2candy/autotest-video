    ...
    {!isLast && (
      ...
      >
        <line
          ...
          strokeWidth="2.5"
        />
        <polygon points="22,3 36,10 22,17" fill={accent} />
      </svg>
    )}
  </div>
);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              "We have a gap in our workflow — testing is manual, process X is
              tedious, system Y has no good tooling."
            </div>
            <div
              style={{
                fontFamily: FONT_FAMILY,
            ...
            >
              "To fix it properly would take a dedicated team and months. Not
          ...
          >
            ...
            >
              "One engineer + AI built internal tools in days to fill these
              exact gaps. Not side projects — working solutions the team
              actually uses."
            </div>
            <div
              style={{
        ...
        >
          ...
          >
            ...
            <span style={{ color: MICROSOFT_BLUE }}>WHAT WE ATTEMPT</span>:
          </div>
